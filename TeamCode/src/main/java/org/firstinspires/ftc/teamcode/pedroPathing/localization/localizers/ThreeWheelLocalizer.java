...
public class ThreeWheelLocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = (.0013+.0013+.0013+.0013+.0013) / 5;
    public static double STRAFE_TICKS_TO_INCHES = (-0.0013-0.0013-.0013-.0013-.0013) / 5;
    public static double TURN_TICKS_TO_RADIANS = (.0016+.0017+.0017+.0017+.0017) / 5;
