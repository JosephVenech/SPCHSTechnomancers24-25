...
@Autonomous(name = "blueBasketObservation")
public class Mk3BlueBasketObservation extends OpMode {
    ...
    private final Pose startPose = new Pose(11, 84, Math.toRadians(0)); //Correct
    ...
    private final Pose parkControlPose = new Pose(11, 24, Math.toRadians(0));
