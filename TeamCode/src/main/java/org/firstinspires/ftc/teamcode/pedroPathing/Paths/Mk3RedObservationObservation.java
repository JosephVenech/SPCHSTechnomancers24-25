...
@Autonomous(name = "redObservationObservation")
public class Mk3RedObservationObservation extends OpMode {
    ...
    private final Pose startPose = new Pose(133, 80.5, Math.toRadians(180));
     ...
     */
    private final Pose parkPose = new Pose(133, 128, Math.toRadians(180));

    private final Pose parkControlPose = new Pose(133, 128, Math.toRadians(180));
    ...
    public void init() {
        ...
        telemetry.addLine("Place Robot in the fourth tile with left wheels aligned to third tile edge.");
