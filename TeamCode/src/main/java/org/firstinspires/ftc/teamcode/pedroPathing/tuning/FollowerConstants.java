...
public class FollowerConstants {
    ...
    private static double xMovement = (40.2696+41.0366+41.1986+41.0968+40.967) / 5;
    private static double yMovement = (29.6845+30.2403+30.9648+31.2295+31.4415) / 5;
    ...
    public static double translationalPIDFFeedForward = 0.010;
    ...
    public static double mass = 12.2016;
    ...
    public static double forwardZeroPowerAcceleration = (-22.9037-21.1265-34.8666-19.203) / 4;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = (30);
    ...
    public static double zeroPowerAccelerationMultiplier = .9;
