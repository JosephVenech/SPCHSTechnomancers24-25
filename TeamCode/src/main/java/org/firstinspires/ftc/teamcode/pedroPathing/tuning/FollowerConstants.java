...
public class FollowerConstants {
    ...
    public static String leftFrontMotorName = "left_back_drive";
    ...
    private static double xMovement = 39.7718;
    private static double yMovement = 28.5554;
    ...
    public static double forwardZeroPowerAcceleration = -22.6642; //-23.5543;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -46.9551; //-78.15554;
